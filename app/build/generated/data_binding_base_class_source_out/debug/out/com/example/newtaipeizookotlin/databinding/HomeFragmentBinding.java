...
public abstract class HomeFragmentBinding extends ViewDataBinding {
  @NonNull
  public final AllAreaNavigationBinding mAllAreaNavigationIC;

  @NonNull
  public final DepartmentSelectpageFragmentBinding mDepartmentSelect;

  protected HomeFragmentBinding(Object _bindingComponent, View _root, int _localFieldCount,
      AllAreaNavigationBinding mAllAreaNavigationIC,
      DepartmentSelectpageFragmentBinding mDepartmentSelect) {
    super(_bindingComponent, _root, _localFieldCount);
    this.mAllAreaNavigationIC = mAllAreaNavigationIC;
    this.mDepartmentSelect = mDepartmentSelect;
  }
